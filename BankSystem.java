...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	public BankSystem () {
		...
		end = new JMenuItem ("Quit Bank System ?", new ImageIcon ("Images/export.gif"));
		...
		about = new JMenuItem ("About Bank System", new ImageIcon ("Images/Save.gif"));
		...
		report = new JMenuItem ("Print Bank System Report", new ImageIcon ("Images/New.gif"));
		...
		btnKey.setToolTipText ("Shortcut Keys of Bank System");
		...
		author = new JLabel (" " + "Bank System Pvt. Lt.", Label.LEFT);
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if (obj == addNew || obj == open || obj == btnNew) {
			...
			boolean b = openChildWindow ("Bank System Help");
			if (b == false) {
				BankHelp hlpBank = new BankHelp ("Bank System Help", "Help/Bank.htm");
				desktop.add (hlpBank);
				hlpBank.show ();
			}
			...
			boolean b = openChildWindow ("Bank System Keys");
			if (b == false) {
				BankHelp hlpKey = new BankHelp ("Bank System Keys", "Help/Keys.htm");
				desktop.add (hlpKey);
				hlpKey.show ();
			}
			...
			String msg = "Bank System Pvt. Lt.";
			JOptionPane.showMessageDialog (this, msg, "About Bank System", JOptionPane.PLAIN_MESSAGE);
		...
		try {
			//Show a Confirmation Dialog.
		    	int reply = JOptionPane.showConfirmDialog (this,
					...
					"Bank System - Exit", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE);
	...
	void getAccountNo () {
		...
		if (b == false) { }
			...
			try {
				...
				"(Tip: Account No. Contains only Digits)", "Bank System - Print Record", JOptionPane.PLAIN_MESSAGE);
				if (printing == null) { }
				if (printing.equals ("")) {
					JOptionPane.showMessageDialog (this, "Provide Account No. to Print.",
						 "Bank System - Empty Field", JOptionPane.PLAIN_MESSAGE);
					getAccountNo ();
				}
				else {
					findRec (printing);
		...
		try {
			...
			if (total == 0) {
				JOptionPane.showMessageDialog (null, "Records File is Empty.\nEnter Records First to Display.",
					 "Bank System - Empty File", JOptionPane.PLAIN_MESSAGE);
				b = false;
			}
			else {
				b = true;
	...
	void findRec (String rec) {
		...
		if (found == false) {
			JOptionPane.showMessageDialog (this, "Account No. " + rec + " doesn't Exist.",
					 "Bank System - Wrong No", JOptionPane.PLAIN_MESSAGE);
			getAccountNo ();
		}
	...
	String makeRecordPrint (int rec) {
		...
		String data;
		String data0 = "               Bank System Pvt. Lt.               \n";	//Page Title.
